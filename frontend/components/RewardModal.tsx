...
const RewardModal: React.FC<RewardModalProps> = ({ 
  ...
  return createPortal(
    <div className="fixed inset-0 z-[10000] bg-black/60 backdrop-blur-md flex items-center justify-center px-6 animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-w-[380px] bg-white dark:bg-card-dark rounded-large p-10 flex flex-col items-center text-center shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] animate-in zoom-in duration-500">
        {/* Celebration Image */}
        <div className="relative w-48 h-48 mb-6">
          <div className="absolute inset-0 bg-accent-orange/20 blur-[40px] rounded-full"></div>
          <img 
            alt="Celebration Trophy" 
            className="relative w-full h-full object-contain transform hover:scale-110 transition-transform duration-500" 
